...
const Article = ({img, title, date, link}) => {
  return(
    ...
    viewport={{once: true}}
    className='relative w-full p-4 py-6 my-4 rounded-xl flex items-center justify-between bg-light text-dark dark:text-light first:mt-0 border border-solid border-dark dark:border-light border-r-4 border-b-4 dark:bg-dark sm:flex-col'>
      <MovingImg 
      title={title}
      img={img}
      link={link}
...
const articles = () => {
  return (
    <>
        ...
        <Head>
                <title>Ayush Chauhan || Articles Page </title>
        ...
        <main className='w-full mb-16 flex flex-col items-center justify-center overflow-hidden  dark:text-light'>
            <Layout className='pt-16'>
              ...
              <FeaturedArticle
                ...
                <h2 className='font-bold w-full text-4xl text-center mt-32'>All Articles</h2>
                <ul>
                  <Article 
